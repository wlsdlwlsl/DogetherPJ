...
<html>
	<head>
		...
		<title>AI Home Trainer : Dumbbell Let pull down</title>
		...
		<div id="test_test_t3" class="t2t2"> <!-- 화면 정 중앙으로 만든 아이디값 : main.css 밑줄에 있음  -->
			...
			<table>
				<tr  id="t_title_tr">
						...
						<td>   <!-- 1 : 운동 종목 -->
							<div id="t_title">Dumbbell Lat pull down
                ...
                <div class="panel-group" id="accordion">  <!-- ## 드롭박스 시작!! -->
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="https://youtu.be/xoWKLNwNva0"><img src="../resources/aihometrainer/images/dumbbellLPD.gif"  style="width:100%" id="img_exs1"/></a>
