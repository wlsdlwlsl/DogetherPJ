				 ...
				 <tr> <!-- 2 : 스타트 버튼 + 타이머 인풋 받는 곳 -->
				 	<td  style="height: 230px;">
						<div id="start_button">	<!-- 입력 및 시작버튼 -->
					 	...
					 	<div> <!-- 타이머 시간 인풋받는 박스 -->
							<input id="timer_input" type="text" name="inputNm" value="30" style="height: 50px; width: 100px; font-size:25px;"/>
							<label> 초(sec)  /  딜레이</label>
							<input id="timer_deley" type="text" name="input_deley" value="5" style="height: 38px; width: 50px; font-size:20px;"/>
							<label> 초(sec)</label>
						</div>
					 </td>
				 </tr>
					...
					<script type="text/javascript">
					   ...
					   // Teachable Machine 내보내기 패널에서 제공하는 모델에 대한 링크
					    ...
					    async function init() {  // ### 2. init 이라는 함수는 model을 불러오고(31-32), 카메라를 설정해준 다음에(35-40), (40)loop라는 함수를 계속 돌게 된다.
					        const modelURL = URL + "squat_model.json";
					        const metadataURL = URL + "squat_metadata.json";
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse in" id="support1">
                      <div class="panel-body">
                    	...
                    	<img src="../resources/aihometrainer/images/chairPose22.jpg" style="width:100%" id="img_exs1"/>
