...
<html>
	<head>
		...
		<title>AI Home Trainer : Wide Squat</title>
							        		 ...
							        		 ViewCount.innerHTML = count;
												...
												$("#ViewTimer_right").text("잘 하고 계세요!");							        		 
								        		 ...
								        		 if(parseInt(count)==parseInt(count_get)){   // 목표숫자가 '  ' 이면  //  inputbox로 바꿈
								        			...
								        			var audio_s = new Audio(URL + 'sound/' +  'success2.mp3');  
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-collapse collapse in" id="support1">
                      <div class="panel-body">
                        ...
                        <a href="https://youtu.be/eDmAFKcekow"><img src="../resources/aihometrainer/images/wideSquat.gif"  style="width:100%" id="img_exs1"/></a>
