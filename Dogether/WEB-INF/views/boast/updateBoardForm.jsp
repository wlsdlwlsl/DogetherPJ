...
<body>
	...
	<div id="ontheside">
		<div class="mainContainer">
			<h3 id="titlee">글 수정하기</h3>
			<div id="cardContent">
				<form method="post" action="updateBoard.do" name="myform" enctype="multipart/form-data">
					...
					<button type="button" class="btn btn-primary" onclick="updatestuff()">수정</button>
